...
function GenerBindEnumKey(ctrlDDLId, enumKey, selectVal) {
    ...
    $.ajax({
        type: 'post',
        async: true,
        url: basePath+"/WF/Comm/gener.do?DoType=EnumList&EnumKey=" + enumKey + "&m=" + Math.random(),
        dataType: 'html',
...
function GenerBindEntities(ctrlDDLId, ensName, selectVal) {
    ...
    $.ajax({
        type: 'post',
        async: true,
        url: basePath+"/WF/Comm/gener.do?DoType=EnsData&EnsName=" + ensName + "&m=" + Math.random(),
        dataType: 'html',
        success: function (data) {
...
function GenerBindSFTable(ctrlDDLId, sfTable, selectVal) {
    ...
    $.ajax({
        type: 'post',
        async: true,
        url: basePath+"/WF/Comm/gener.do?DoType=SFTable&SFTable=" + sfTable + "&m=" + Math.random(),
        dataType: 'html',
        success: function (data) {
            data = JSON.parse(data);
            //绑定枚举值.
...
function GenerBindSQL(ctrlDDLId, sqlKey, paras, colNo, colName, selectVal) {
    ...
    $.ajax({
        type: 'post',
        async: true,
        url: basePath+"/WF/Comm/gener.do?DoType=SQLList&SQLKey=" + sqlKey + "&Paras=" + paras + "&m=" + Math.random(),
        dataType: 'html',
        success: function (data) {
