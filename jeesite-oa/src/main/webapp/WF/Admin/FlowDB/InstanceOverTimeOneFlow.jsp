...
<html>
  <head>
    ...
    <script type="text/javascript">
        ...
        function loadFlowUSLChartType() {
            ...
            window.location.href = "InstanceOverTimeOneFlow.jsp?anaTime=" + str1 + "&FK_Flow=" + fk_flow + "&";
        }
    </script>
  ...
  <body>
    <table id="tableContent" style="width: 100%;">
        <caption style=" text-align: center; color: red;">逾期分析</caption>
        <tr>
            <td valign="top">
                <!-- 总数分析..... -->
                <fieldset>
                    ...
                    <table style="width: 80%;">
                        ...
                        <tr>
                            ...
                            <td>
                               <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE  FK_Flow=" + fk_flow + "   AND WorkID  in(SELECT distinct WorkID FROM WF_CH) and WFState !=  '" +BP.WF.WFState.Complete.getValue() + "' ")%>
                            </td>
                            <td>
                                个
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                             <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE  FK_Flow=" + fk_flow + "   AND WorkID  in(SELECT distinct WorkID FROM WF_CH) and WFState =  '" +BP.WF.WFState.Complete.getValue() + "' ")%>                            </td>
                            <td>
                                个
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow=" + fk_flow + "   AND WorkID  in(SELECT distinct WorkID FROM WF_CH) and WFState='" + BP.WF.WFState.ReturnSta.getValue() + "'   ")%>
                            </td>
                            <td>
                                个
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow=" + fk_flow + "  AND WorkID  in(SELECT distinct WorkID FROM WF_CH) and WFState='" + BP.WF.WFState.Delete.getValue() + "' ")%>
                            </td>
                            <td>
                                个
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow=" + fk_flow + "   AND WorkID  in(SELECT distinct WorkID FROM WF_CH) and WFSta='" + BP.WF.WFSta.Etc.getValue() + "' ")%>
                            </td>
                            <td>
                                个
                            </td>
            ...
            <td valign="top">
                ...
                <fieldset>
                    ...
                    <%
                        ...
                        int SYF = BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow='" + fk_flow + "'   AND WorkID  in(SELECT distinct WorkID FROM WF_CH) and FK_NY='" + FK_NY + "' ");

                        int SSYF = BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow='" + fk_flow + "'   AND WorkID  in(SELECT distinct WorkID FROM WF_CH) and FK_NY='" + ShangFK_NY + "' ");
                        int TBZZS = SYF - SSYF;
                        String TBZZL = "×";
                        if (SYF == 0 || SSYF == 0){
                            TBZZL = "×";
                    ...
                    <table style="width: 80%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow='" + fk_flow + "'   AND WorkID  in(SELECT distinct WorkID FROM WF_CH) and WFState!='" + BP.WF.WFState.Complete.getValue() + "' AND  FK_NY='" + FK_NY + "' ")%>
                            </td>
                            <td>
                                个
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow='" + fk_flow + "'   AND WorkID  in(SELECT distinct WorkID FROM WF_CH) and WFState='" + BP.WF.WFState.ReturnSta.getValue() + "' AND  FK_NY='" + FK_NY + "'  ")%>
                            </td>
                            <td>
                                个
                            </td>
            ...
            <td valign="top">
                ...
                <fieldset>
                    ...
                    <%
                        ...
                        int SZZS = BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow= '" + fk_flow + "'  AND WorkID  in(SELECT distinct WorkID FROM WF_CH) and WeekNum=" + priWeek);
                        int SSZZS = BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow= '" + fk_flow + "'   AND WorkID  in(SELECT distinct WorkID FROM WF_CH) and WeekNum=" + ShangpriWeek);
                        String ZTBZZL = "×";
                        //同比增长
                    ...
                    <table style="width: 80%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow='" + fk_flow + "'   AND WorkID  in(SELECT distinct WorkID FROM WF_CH) and WFState!='" + BP.WF.WFState.Complete.getValue() + "' AND WeekNum=" + priWeek)%>
                            </td>
                            <td>
                                个
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <%=BP.DA.DBAccess.RunSQLReturnValInt("SELECT COUNT(WorkID) FROM WF_GenerWorkFlow WHERE FK_Flow='" + fk_flow + "'   AND WorkID  in(SELECT distinct WorkID FROM WF_CH) and WFState='" + BP.WF.WFState.ReturnSta.getValue() + "' AND   WeekNum=" + priWeek)%>
                            </td>
                            <td>
                                个
                            </td>
            ...
            <td>
                ...
                <%
                    ...
                    if("mouth".equals(anaTime)){
                    	sql = "select  COUNT(DeptName) Num, DeptName from WF_GenerWorkFlow" +
                                "  where FK_Flow=" + fk_flow + "   AND WorkID  in(SELECT distinct WorkID FROM WF_CH) AND FK_NY='" + sdf.format(dTime) + "' group  by DeptName";
                    	...
                    	sql = "select  COUNT(DeptName) Num, DeptName from WF_GenerWorkFlow" +
                                "  where  FK_Flow=" + fk_flow + "   AND WorkID  in(SELECT distinct WorkID FROM WF_CH) AND  RDT LIKE'" + sdf2.format(dTime) + "%'  group  by DeptName";
