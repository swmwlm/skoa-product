...
<%@page import="cn.jflow.foolform.model.FoolFormDesingerModel" %>
<html>
<%
	FoolFormDesingerModel foolForm = new FoolFormDesingerModel(request,response);
	foolForm.pageLoad();
%>
<head>
...
<style type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Insert(mypk, IDX) {
            var url = '../../MapDef/FieldTypeList.htm?DoType=AddF&MyPK=' + mypk + '&IDX=' + IDX;
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 500px; dialogWidth: 700px;center: yes; help: no');
            window.location.href = window.location.href;
        }
        function AddF(fk_mapdata) {
            //var url = 'Do.htm?DoType=AddF&MyPK=' + mypk;
            var url = '../../MapDef/FieldTypeList.htm?DoType=AddF&FK_MapData=' + fk_mapdata;
        ...
        function AddField(fk_mapdata, groupID) {
            var url = '../../MapDef/FieldTypeList.htm?DoType=AddF&FK_MapData=' + fk_mapdata + '&GroupField=' + groupID;
        ...
        function GroupFieldNew(mypk) {
            var url = '../../MapDef/GroupField.htm?FK_MapData=' + mypk + "&RefOID=0&DoType=FunList";
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 500px; dialogWidth: 600px;center: yes; help: no');
            window.location.href = window.location.href;
        }
        function ExpImp(fk_mapdata, fk_flow) {
            var url = '../../MapDef/ExpImp.htm?FK_MapData=' + fk_mapdata + "&DoType=FunList&FK_Flow=" + fk_flow;
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 400px; dialogWidth: 600px;center: yes; help: no');
            window.location.href = window.location.href;
        }
        function GroupField(mypk, OID) {
            var url = '../../MapDef/GroupFieldEdit.htm?FK_MapData=' + mypk + "&GroupField=" + OID;
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 500px; dialogWidth: 600px;center: yes; help: no');
            window.location.href = window.location.href;
        }

        function GroupFieldDel(mypk, refoid) {
            var url = '../../MapDef/GroupField.htm?RefNo=' + mypk + '&DoType=DelIt&RefOID=' + refoid;
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 500px; dialogWidth: 700px;center: yes; help: no');
            window.location.href = window.location.href;
        }

        function Edit(fk_mapdata, mypk, ftype, gf) {
            var url = '../../MapDef/EditF.htm?DoType=Edit&MyPK=' + mypk + '&FType=' + ftype + '&FK_MapData=' + fk_mapdata + '&GroupField=' + gf;
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 500px; dialogWidth: 700px;center: yes; help: no');
            window.location.href = window.location.href;
        }

        function EditEnum(fk_mapdata,keyOfEn, mypk, enumKey,gf) {
            var url = '../../MapDef/EditEnum.htm?DoType=Edit&FK_MapData=' + fk_mapdata + '&MyPK=' + mypk + '&EnumKey=' + enumKey + '&KeyOfEn=' + keyOfEn+ '&GroupField=' + gf;
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 500px; dialogWidth: 700px;center: yes; help: no');
            window.location.href = window.location.href;
        }

        function EditTable(fk_mapdata, keyOfEn, mypk, sfTable,gf) {
            var url = '../../MapDef/EditTableField.htm?DoType=Edit&FK_MapData=' + fk_mapdata + '&MyPK=' + mypk + '&FK_SFTable=' + sfTable + '&KeyOfEn=' + keyOfEn+ '&GroupField=' + gf;
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 500px; dialogWidth: 700px;center: yes; help: no');
            window.location.href = window.location.href;
        }
        ...
        function EditFrmThread(mypk) {
            var url = '../../Comm/RefFunc/UIEn.jsp?EnName=BP.WF.Template.FrmTrack&PK=' + mypk
        ...
        function EditFWC(mypk) {
            ...
            var url = '../../Comm/RefFunc/UIEn.jsp?EnName=BP.WF.Template.FrmNodeComponent&PK=' + mypk + '&tab=审核组件';
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 400px; dialogWidth: 700px;center: yes; help:no;resizable:yes');
            window.location.href = window.location.href;
        }
        //子流程.
        function EditSubFlow(mypk) {
            ...
            var url = '../../Comm/RefFunc/UIEn.jsp?EnName=BP.WF.Template.FrmNodeComponent&PK=' + mypk + '&tab=父子流程组件';
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 400px; dialogWidth: 700px;center: yes; help:no;resizable:yes');
            window.location.href = window.location.href;
        }
        ...
        function EditThread(mypk) {
            // var url = '../Comm/RefFunc/UIEn.aspx?EnName=BP.WF.Template.FrmSubFlow&PK=' + mypk
            var url = '../../Comm/RefFunc/UIEn.jsp?EnName=BP.WF.Template.FrmNodeComponent&PK=' + mypk + '&tab=子线程组件';
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 400px; dialogWidth: 700px;center: yes; help:no;resizable:yes');
            window.location.href = window.location.href;
        }
        ...
        function EditFTC(mypk) {
            // var url = '../Comm/RefFunc/UIEn.aspx?EnName=BP.WF.Template.FrmSubFlow&PK=' + mypk
            var url = '../../Comm/RefFunc/UIEn.jsp?EnName=BP.WF.Template.FrmNodeComponent&PK=' + mypk + '&tab=流转自定义';
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 400px; dialogWidth: 700px;center: yes; help:no;resizable:yes');
            window.location.href = window.location.href;
        }
        ...
        function EditTrack(mypk) {
            // var url = '../Comm/RefFunc/UIEn.aspx?EnName=BP.WF.Template.FrmSubFlow&PK=' + mypk
            var url = '../../Comm/RefFunc/UIEn.jsp?EnName=BP.WF.Template.FrmNodeComponent&PK=' + mypk + '&tab=轨迹组件';
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 400px; dialogWidth: 700px;center: yes; help:no;resizable:yes');
            window.location.href = window.location.href;
        }
        ...
        function MapDataEdit(mypk) {
            var url = '../../Comm/RefFunc/UIEn.jsp?EnName=BP.WF.Template.MapFoolForm&PK=' + mypk
        ...
        function FrmNodeComponent(mypk) {
            var url = '../../Comm/RefFunc/UIEn.jsp?EnName=BP.WF.Template.FrmNodeComponent&PK=' + mypk
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 500px; dialogWidth: 850px;center: yes; help: no');
            window.location.href = window.location.href;
        }
        ...
        function NewMapDtl(fk_mapdata) {
            ...
            $.ajax({
                type: 'post',
                async: true,
                url: basePath+"/WF/MapDef/MapDef.do?DoType=Designer_NewMapDtl&FK_MapData=" + fk_mapdata + "&DtlNo=" + val + "&m=" + Math.random(),
                dataType: 'html',
                success: function (data) {
                    ...
                    var url = '../../MapDef/MapDtl.htm?DoType=Dtl_Init&FK_MapData=' + fk_mapdata + '&FK_MapDtl=' + data;
                    var b = window.showModalDialog(url, 'ass', 'dialogHeight: 500px; dialogWidth: 600px;center: yes; help: no');
                    window.location.href = window.location.href;
                    return;
                }
        ...
        function EditDtl(fk_mapdata, mypk) {
            ...
            var url = '../../MapDef/MapDtl.htm?DoType=Dtl_Init&FK_MapData=' + fk_mapdata + '&FK_MapDtl=' + mypk;
        ...
        function EditAth(fk_mapdata, ath) {
            var url = '../../MapDef/Attachment.htm?DoType=Attachment_Init&FK_MapData=' + fk_mapdata + '&MyPK='+ fk_mapdata+"_"+ ath;
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 500px; dialogWidth: 800px;center: yes; help: no');
            window.location.href = window.location.href;
        }
        ...
        function NewAth(fk_mapdata) {
            ...
            $.ajax({
                type: 'post',
                async: true,
                url: basePath+"/WF/MapDef/MapDef.do?DoType=Designer_AthNew&FK_MapData=" + fk_mapdata + "&AthNo=" + val + "&m=" + Math.random(),
                dataType: 'html',
                success: function (data) {
                    if (data.indexOf('err@') == 0) {
                        alert(data);
                    ...
                    var url = '../../MapDef/Attachment.htm?DoType=Attachment_Init&FK_MapData=' + fk_mapdata + '&MyPK=' + data;
                    var b = window.showModalDialog(url, 'ass', 'dialogHeight: 500px; dialogWidth: 600px;center: yes; help: no');
                    window.location.href = window.location.href;
                    return;
                }
        ...
        function NewFrame(fk_mapdata) {
            ...
            $.ajax({
                type: 'post',
                async: true,
                url: basePath+"/WF/MapDef/MapDef.do?DoType=Designer_NewFrame&FK_MapData=" + fk_mapdata + "&FrameNo=" + val + "&m=" + Math.random(),
                dataType: 'html',
                success: function (data) {
                    if (data.indexOf('err@') == 0) {
                        alert(data);
                    ...
                    var url = '../../MapDef/MapFrame.htm?DoType=MapFrame_Init&FK_MapData=' + fk_mapdata + '&MyPK=' + data;
                    var b = window.showModalDialog(url, 'ass', 'dialogHeight: 500px; dialogWidth: 600px;center: yes; help: no');
                    window.location.href = window.location.href;
                    return;
                }
        ...
        function EditFrame(fk_mapdata, myPK) {
            var url = '../../MapDef/MapFrame.htm?DoType=MapFrame_Init&FK_MapData=' + fk_mapdata + '&MyPK=' + myPK;
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 500px; dialogWidth: 600px;center: yes; help: no');
            window.location.href = window.location.href;
        }
        ...
        function HidAttr(fk_mapData) {
            var url = '../../MapDef/HidAttr.htm?FK_MapData=' + fk_mapData;
            var b = window.showModalDialog(url, 'ass', 'dialogHeight: 500px; dialogWidth: 700px;center: yes; help: no');
            window.location.href = window.location.href;
        }
...
<body ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1">
	<div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'north'" style="height: auto; padding: 5px; overflow-y: hidden;">
            ...
            <a href="javascript:MapDataEdit('<%=fk_mapdata %>');" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-property'">
                表单属性</a>
            <% if (StringHelper.isNullOrEmpty(fk_flow) == false)
               { %>
