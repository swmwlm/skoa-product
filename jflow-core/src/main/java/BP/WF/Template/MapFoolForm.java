...
//		return i;
	...
	*/
	public final String DoNodeFrmCompent()
	{
		...
		{
			return SystemConfig.getCCFlowWebPath() + "WF/Comm/RefFunc/UIEn.aspx?EnName=BP.WF.Template.FrmNodeComponent&PK=" + this.getNo().replace("ND", "") + "&t=" + DataType.getCurrentDataTime();
		}
		else
		{
			return SystemConfig.getCCFlowWebPath() + "WF/Admin/FoolFormDesigner/Do.aspx&DoType=FWCShowError";
		}
	}
	/** 
	 执行旧版本的兼容性检查.
	...
	*/
	...
	{
		return SystemConfig.getCCFlowWebPath() + "WF/Admin/FoolFormDesigner/MapExt/RegularExpressionBatch.aspx?FK_Flow=&FK_MapData=" + this.getNo() + "&t=" + DataType.getCurrentDataTime();
	}
	/** 
	 批量修改字段
	...
	*/
	...
	{
		return SystemConfig.getCCFlowWebPath() + "WF/Admin/FoolFormDesigner/BatchEdit.aspx?FK_MapData=" + this.getNo() + "&t=" + DataType.getCurrentDataTime();
	}
	/** 
	 排序字段顺序
	...
	*/
	...
	{
		return SystemConfig.getCCFlowWebPath() + "WF/Admin/AttrNode/SortingMapAttrs.aspx?FK_Flow=&FK_MapData=" + this.getNo() + "&t=" + DataType.getCurrentDataTime();
	}
	/** 
	 设计表单
	...
	*/
	...
	{
		String url = SystemConfig.getCCFlowWebPath() + "WF/Admin/FoolFormDesigner/CCForm/Frm.aspx?FK_MapData=" + this.getNo() + "&UserNo=" + BP.Web.WebUser.getNo() + "&SID=" + WebUser.getSID() + "&AppCenterDBType=" + BP.DA.DBAccess.getAppCenterDBType() + "&CustomerNo=" + BP.Sys.SystemConfig.getCustomerNo();
		try {
	...
	*/
	...
	{
		String url = SystemConfig.getCCFlowWebPath() + "WF/Admin/FoolFormDesigner/Designer.aspx?FK_MapData=" + this.getNo() + "&UserNo=" + BP.Web.WebUser.getNo() + "&SID=" + WebUser.getSID() + "&AppCenterDBType=" + BP.DA.DBAccess.getAppCenterDBType() + "&CustomerNo=" + BP.Sys.SystemConfig.getCustomerNo();
		try {
			PubClass.WinOpen(null, url, 800, 650);
		} catch (IOException e) {
	...
	*/
	...
	{
		return SystemConfig.getCCFlowWebPath() + "WF/Comm/Search.aspx?s=34&FK_MapData=" + this.getNo() + "&EnsName=" + this.getNo();
	}
	/** 
	 调用分析API
	...
	*/
	...
	{
		return SystemConfig.getCCFlowWebPath() + "WF/Comm/Group.aspx?s=34&FK_MapData=" + this.getNo() + "&EnsName=" + this.getNo();
	}
	/** 
	 数据源管理
	...
	*/
	...
	{
		return SystemConfig.getCCFlowWebPath() + "WF/Comm/Search.aspx?s=34&FK_MapData=" + this.getNo() + "&EnsName=BP.Sys.SFDBSrcs";
	}
	public final String DoWordFrm()
	{
		return SystemConfig.getCCFlowWebPath() + "WF/Admin/FoolFormDesigner/MapExt/WordFrm.aspx?s=34&FK_MapData=" + this.getNo() + "&ExtType=WordFrm&RefNo=";
	}
	public final String DoExcelFrm()
	{
		return SystemConfig.getCCFlowWebPath() + "WF/Admin/FoolFormDesigner/MapExt/ExcelFrm.aspx?s=34&FK_MapData=" + this.getNo() + "&ExtType=ExcelFrm&RefNo=";
	}
	public final String DoPageLoadFull()
	{
		return SystemConfig.getCCFlowWebPath() + "WF/Admin/FoolFormDesigner/MapExt/PageLoadFull.aspx?s=34&FK_MapData=" + this.getNo() + "&ExtType=PageLoadFull&RefNo=";
	}
	public final String DoInitScript()
	{
		return SystemConfig.getCCFlowWebPath() + "WF/Admin/FoolFormDesigner/MapExt/InitScript.aspx?s=34&FK_MapData=" + this.getNo() + "&ExtType=PageLoadFull&RefNo=";
	}
	/** 
	 表单属性.
	...
	*/
	...
	{
		return SystemConfig.getCCFlowWebPath() + "WF/Admin/FoolFormDesigner/MapExt/BodyAttr.aspx?s=34&FK_MapData=" + this.getNo() + "&ExtType=BodyAttr&RefNo=";
	}
	/** 
	 表单事件
	...
	*/
	...
	{
		return SystemConfig.getCCFlowWebPath() + "WF/Admin/Action.aspx?FK_MapData=" + this.getNo() + "&T=sd&FK_Node=0";
	}
	/** 
	 导出
	...
	*/
	...
	{
		return SystemConfig.getCCFlowWebPath() + "WF/Admin/FoolFormDesigner/MapExt/List.aspx?FK_MapData=" + this.getNo() + "&T=sd";
	}
	/** 
	 导出表单
	...
	*/
	...
	{
		String urlExt = SystemConfig.getCCFlowWebPath() + "WF/Admin/XAP/DoPort.aspx?DoType=DownFormTemplete&FK_MapData=" + this.getNo();
		try {
