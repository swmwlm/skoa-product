...
<body>
   <%
        ...
        {
            sBuilder.append("<th >" + "<a href='EmpWorks.jsp?GroupBy=FlowName" + extStr + "&T=" + timeKey + "' >流程</a>" + "</th>");
        }

        if (!GroupBy.equals("NodeName"))
        {
            sBuilder.append("<th >" + "<a href='EmpWorks.jsp?GroupBy=NodeName" + extStr + "&T=" + timeKey + "' >节点</a>" + "</th>");
        }

        if (!GroupBy.equals("StarterName"))
        {
            sBuilder.append("<th >" + "<a href='EmpWorks.jsp?GroupBy=StarterName" + extStr + "&T=" + timeKey + "' >发起人</a>" + "</th>");
        }

        sBuilder.append("<th >" + "<a href='EmpWorks.jsp?GroupBy=PRI" + extStr + "&T=" + timeKey + "' >优先级</a>" + "</th>");
